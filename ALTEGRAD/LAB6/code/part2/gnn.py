...
for epoch in range(epochs):
    ...
    for i in range(0, N_train, batch_size):
        ...
        for j in range(i, min(i+batch_size, N_train)):
            ...
            A_tild = adj + sp.identity(n)
            adj_batch.append(A_tild)
...
'''
Epoch: 0191 loss_train: 0.2968 acc_train: 0.8556 time: 0.0224s
Optimization finished!
loss_test: 0.4812 acc_test: 0.7000 time: 0.0250s
'''
